...
📄 文件:[`docs/ARCHITECTURE.md`](docs/ARCHITECTURE.md)(設計/技術債/分階段)· [`docs/ALGORITHMS.md`](docs/ALGORITHMS.md)(逐階段演算法細節)· [`docs/diagrams/`](docs/diagrams/README.md)(L0–L2 系統圖組)· [`docs/schema/`](docs/schema/README.md)(欄位契約 + MCP tool 介面)· [`docs/prompts/`](docs/prompts/README.md)(全部 LLM/VLM prompt 定義)
